...
<%
Bean bean=new Bean();
String source=request.getParameter("d1");
String amount=request.getParameter("d2");
	  ...
	  double accbal=rs.getDouble("balance")+ amnt;
          ...
          if(rs.next())
          {
           bean.setBalance(rs.getInt("balance"));
            response.sendRedirect("Userhome.jsp?dep=success");%>
...
<a href="Userhome.jsp">Home</a> --%>
	 ...
	 response.sendRedirect("Userhome.jsp?dep=failure");
    %>
